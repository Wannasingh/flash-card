...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."badges" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."badges_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."flyway_schema_history" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."roles" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."roles_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."store_items" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."store_items_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."user_badges" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."user_badges_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."user_identities" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."user_identities_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."user_inventory" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."user_inventory_id_seq" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."user_roles" TO "flashcard_app";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "flashcard"."users" TO "flashcard_app";



GRANT ALL ON SEQUENCE "flashcard"."users_id_seq" TO "flashcard_app";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "flashcard" GRANT ALL ON SEQUENCES TO "flashcard_app";



ALTER DEFAULT PRIVILEGES FOR ROLE "postgres" IN SCHEMA "flashcard" GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLES TO "flashcard_app";
