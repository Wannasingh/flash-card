...
CREATE POLICY "Users can upload to their own profile folder" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'flashcard.profile.picture'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Users can view their own profile folder" ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'flashcard.profile.picture'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));
